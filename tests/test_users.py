...
class TestUserRegistration:
    ...
    async def test_register_user_invalid_email(self, client: AsyncClient, db_session: AsyncSession):
    ...
    async def test_register_user_short_password(self, client: AsyncClient, db_session: AsyncSession):
...
class TestUserLogin:
    ...
    async def test_login_user_success(self, client: AsyncClient, db_session: AsyncSession):
    ...
    async def test_login_user_invalid_credentials(self, client: AsyncClient, db_session: AsyncSession):
    ...
    async def test_login_user_nonexistent(self, client: AsyncClient, db_session: AsyncSession):
...
class TestUserAuthentication:
    ...
    async def test_get_current_user_invalid_token(self, client: AsyncClient, db_session: AsyncSession):
    ...
    async def test_get_current_user_no_token(self, client: AsyncClient, db_session: AsyncSession):
...
class TestUserCRUD:
    ...
    async def test_get_users_list(self, client: AsyncClient, db_session: AsyncSession):
        ...
        users_data = [
            {"email": "user1@example.com", "password": "password123", "user_type": "FARMER"},
            {"email": "user2@example.com", "password": "password123", "user_type": "BUYER"},
        ]
    ...
    async def test_get_user_by_id_not_found(self, client: AsyncClient, db_session: AsyncSession):
    ...
    async def test_get_user_by_id_invalid_format(self, client: AsyncClient, db_session: AsyncSession):
    ...
    async def test_update_user_unauthorized(self, client: AsyncClient, db_session: AsyncSession):
    ...
    async def test_delete_user_success(self, client: AsyncClient, db_session: AsyncSession):
        """Test deleting user."""
        # Register and login user
        user_data = {
            "email": "test@example.com",
